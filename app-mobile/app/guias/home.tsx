...
const styles = StyleSheet.create({
  ...
  header: { paddingTop: 20, paddingBottom: 10, paddingHorizontal: 15, borderBottomWidth: 1, borderBottomColor: '#ddd' },
  title: { fontSize: 28, fontWeight: 'bold', textAlign: 'center', marginBottom: 10 },
  navLinks: { flexDirection: 'row', justifyContent: 'space-between' },
  link: { color: '#007bff', fontSize: 16 },
  card: { flexDirection: 'row', padding: 15, marginHorizontal: 10, marginTop: 10, backgroundColor: '#fff', borderRadius: 10, alignItems: 'center', elevation: 3 },
